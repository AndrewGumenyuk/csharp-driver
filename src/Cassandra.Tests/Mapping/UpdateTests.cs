...
namespace Cassandra.Tests.Mapping
{
    ...
    public class UpdateTests : MappingTestBase
    {
        ...
        public void Update_With_Multiple_PartitionKeys()
        {
            ...
            TestHelper.VerifyUpdateCqlColumns("Song", query, new []{ "Artist", "ReleaseDate" }, new []{ "Id", "Title" });
        ...
        public void Update_With_ClusteringKey()
        {
            ...
            mapper.Update(song);
            TestHelper.VerifyUpdateCqlColumns("Song", query, new []{ "Artist", "Title" }, new []{ "Id", "ReleaseDate" });
        ...
        public void Update_Cql_Prepends()
        {
            ...
            TestHelper.VerifyUpdateCqlColumns("Song", query, new []{ "title" }, new []{ "id" });
        }
        ...
        public void UpdateIf_AppliedInfo_True_Test()
        {
            ...
            TestHelper.VerifyUpdateCqlColumns("Song", query, new []{ "title", "releasedate" }, new []{ "id", "artist" });
